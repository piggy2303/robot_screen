const data_man_chinh = [
  {
    id: 0,
    id_sound: "DauHieuNhanBietCOvid19",
    title_vi: "Dấu hiệu nhận biết bệnh",
    detail_vi:
      "Các dấu hiệu nhận biết nhiễm Corona Dấu hiệu 1: cảm thấy khó thở Triệu chứng rõ nét và cũng nguy hiểm nhất gây ra bởi viêm phổi do virus corona chính là khó thở. Nếu bạn bị ngạt mũi và cảm giác nghẹn ở họng và lồng ngực, đó có thể là dấu hiệu của cơ thể báo động bạn bị viêm phổi do virus mới gây ra. Dấu hiệu 2: Ho nhiều Ho là triệu chứng nguy hiểm thứ hai có thể xuất hiện khi mắc virus corona. Ho do corona sẽ không khỏi khi uống thuốc trị ho bình thường.",
  ...
  {
    id: 3,
    id_sound: "CaNuocCUngCHongDich",
    title_vi: "Cả nước cùng chống dịch",
    detail_vi:
    ...
    thumbnail: require("./img_coro/canuoc.jpg"),
    list_img: [
  ...
  },
  {
    ...
    thumbnail: require("./img_coro/khuyencao2.jpg"),
    list_img: [
      { id: 0, src: require("./img_coro/khuyencao0.jpeg") },
